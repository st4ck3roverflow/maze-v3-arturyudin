...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        Form.resize(630, 275)
        ch_box_style = "QCheckBox {color: #2eec71; font: 12pt \"System\"; font-weight: bold; padding-top: -1px;} QCheckBox::indicator {width: 15px; height: 15px; border: 1px solid #2eec71; } QCheckBox::indicator:checked {background-color: #2eec71;}"
        self.label = QtWidgets.QLabel(Form)
        self.label.setGeometry(QtCore.QRect(0, 0, 630, 275))
        self.label.setStyleSheet("background-color: #161616;")
        self.label.setText("")
        self.label.setObjectName("label")
        self.label_2 = QtWidgets.QLabel(Form)
        self.label_2.setGeometry(QtCore.QRect(0, 0, 630, 27))
        self.label_2.setStyleSheet("background-color: #242424;")
        self.label_2.setText("")
        self.label_2.setObjectName("label_2")
        self.label_3 = QtWidgets.QLabel(Form)
        self.label_3.setGeometry(QtCore.QRect(0, 27, 630, 2))
        self.label_3.setStyleSheet("background-color: #242424;")
        self.label_3.setText("")
        self.label_3.setObjectName("label_3")
        self.label_4 = QtWidgets.QLabel(Form)
        self.label_4.setGeometry(QtCore.QRect(3, 2, 523, 23))
        self.label_4.setStyleSheet("font: 14pt \"System\";")
        self.label_4.setObjectName("label_4")
        self.label_5 = QtWidgets.QLabel(Form)
        self.label_5.setGeometry(QtCore.QRect(5, 35, 200, 235))
        self.label_5.setStyleSheet("background-color: #161616; border: 1px solid #2eec71;")
        self.label_5.setText("")
        self.label_5.setObjectName("label_5")
        self.label_6 = QtWidgets.QLabel(Form)
        self.label_6.setGeometry(QtCore.QRect(5, 35, 200, 30))
        self.label_6.setStyleSheet("background-color: #161616; font: 14pt \"System\"; border: 1px solid #2eec71;")
        ...
        self.pushButton_3.setStyleSheet(
            "QPushButton{background-color: rgb(255,255,255); border: none; border-radius: 2px;}")
        self.pushButton_3.setText("")
        self.pushButton_3.setObjectName("pushButton_3")
        self.checkBox_2 = QtWidgets.QCheckBox(Form)
        self.checkBox_2.setGeometry(QtCore.QRect(10, 95, 135, 18))
        self.checkBox_2.setStyleSheet(ch_box_style)
        self.checkBox_2.setObjectName("checkBox_2")
        self.checkBox_3 = QtWidgets.QCheckBox(Form)
        self.checkBox_3.setGeometry(QtCore.QRect(10, 120, 300, 18))
        ...
        self.horizontalSlider.setStyleSheet(
            "QSlider::groove:horizontal {border: 1px solid #242424; height: 9px; background: #161616;} QSlider::handle:horizontal {background: #2eec71; width: 15px;}")
        ...
        self.lineEdit.setStyleSheet(
            "background-color: rgb(30,30,30); border: 1px solid #2eec71; border-radius: 2px; color: #2eec71; font: 10pt \"System\"; font-weight: bold;")
        self.lineEdit.setMaxLength(5)
        self.lineEdit.setAlignment(QtCore.Qt.AlignCenter)
        self.lineEdit.setObjectName("lineEdit")
        self.checkBox_5 = QtWidgets.QCheckBox(Form)
        self.checkBox_5.setGeometry(QtCore.QRect(10, 190, 135, 18))
        ...
        self.label_7.setStyleSheet("background-color: #161616; border: 1px solid #2eec71;")
        self.label_7.setText("")
        self.label_7.setObjectName("label_7")
        self.label_8 = QtWidgets.QLabel(Form)
        self.label_8.setGeometry(QtCore.QRect(215, 35, 200, 30))
        self.label_8.setStyleSheet("background-color: #161616; font: 14pt \"System\"; border: 1px solid #2eec71;")
        self.label_8.setObjectName("label_8")
        self.checkBox_7 = QtWidgets.QCheckBox(Form)
        self.checkBox_7.setGeometry(QtCore.QRect(220, 70, 150, 18))
        self.checkBox_7.setStyleSheet(ch_box_style)
        self.checkBox_7.setObjectName("checkBox_7")
        self.comboBox = QtWidgets.QComboBox(Form)
        self.comboBox.setGeometry(QtCore.QRect(320, 92, 90, 23))
        self.comboBox.setStyleSheet(
            "QComboBox{ font: 12pt System; font-size: 14px; border: none; background-color: #161616; color: #2eec71; font-weight: bold; border: 1px solid #242424;} QComboBox::drop-down{border: none; background-color: #242424; font-weight: bold;}")
        ...
        self.label_9.setStyleSheet("font: 12pt \"System\";")
        self.label_9.setObjectName("label_9")
        self.label_10 = QtWidgets.QLabel(Form)
        self.label_10.setGeometry(QtCore.QRect(220, 120, 33, 20))
        self.label_10.setStyleSheet("font: 12pt \"System\";")
        ...
        self.label_11.setStyleSheet("font: 12pt \"System\";")
        ...
        self.label_12.setStyleSheet("font: 12pt \"System\";")
        ...
        self.label_13.setStyleSheet("font: 12pt \"System\";")
        ...
        self.label_14.setStyleSheet("background-color: #161616; border: 1px solid #2eec71;")
        self.label_14.setText("")
        self.label_14.setObjectName("label_14")
        self.label_15 = QtWidgets.QLabel(Form)
        self.label_15.setGeometry(QtCore.QRect(425, 35, 200, 30))
        self.label_15.setStyleSheet("background-color: #161616; font: 14pt \"System\"; border: 1px solid #2eec71;")
        ...
        self.checkBox_15.setGeometry(QtCore.QRect(430, 195, 228, 18))
        self.checkBox_15.setStyleSheet(ch_box_style)
        self.checkBox_15.setObjectName("checkBox_15")
        self.pushButton = QtWidgets.QPushButton(Form)
        self.pushButton.setGeometry(QtCore.QRect(605, 0, 25, 27))
        self.pushButton.setStyleSheet(
            "QPushButton{color: #2eec71; background-color: #242424; font-size: 18px; font-weight: bold; border: none;padding-left: 2px;} QPushButton:hover {color: red; background-color: rgb(70,70,70);} QPushButton:pressed {background-color: rgb(75,75,75);}")
        self.pushButton.setObjectName("pushButton")
        self.pushButton_2 = QtWidgets.QPushButton(Form)
        self.pushButton_2.setGeometry(QtCore.QRect(580, 0, 25, 27))
        self.pushButton_2.setStyleSheet(
            "QPushButton{color: #2eec71; background-color: #242424; font-size: 18px; font-weight: bold; border: none;padding-left: 2px;} QPushButton:hover {background-color: rgb(70,70,70);} QPushButton:pressed {background-color: rgb(75,75,75);}")
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "maze v3 (arturyud.in version)"))
        self.label_4.setText(_translate("Form",
                                        "<html><head/><body><p><span style=\" font-weight:600; color:#2eec71;\">maze v3 (arturyud.in version)</span></p></body></html>"))
        self.label_6.setText(_translate("Form",
                                        "<html><head/><body><p align=\"center\"><span style=\" font-weight:600; color:#2eec71;\">visual</span></p></body></html>"))
        self.checkBox.setText(_translate("Form", "esp"))
        self.checkBox_2.setText(_translate("Form", "health based esp"))
        ...
        self.checkBox_6.setText(_translate("Form", "ingame wh"))
        self.label_8.setText(_translate("Form",
                                        "<html><head/><body><p align=\"center\"><span style=\" font-weight:600; color:#2eec71;\">target</span></p></body></html>"))
        self.checkBox_7.setText(_translate("Form", "aim bot (on m1)"))
        ...
        self.label_9.setText(_translate("Form",
                                        "<html><head/><body><p><span style=\" font-weight:600; color:#2eec71;\">aim bone</span></p></body></html>"))
        self.label_10.setText(_translate("Form",
                                         "<html><head/><body><p><span style=\" font-weight:600; color:#2eec71;\">fov</span></p></body></html>"))
        self.lineEdit_3.setText(_translate("Form", "26"))
        self.label_11.setText(_translate("Form",
                                         "<html><head/><body><p><span style=\" font-weight:600; color:#2eec71;\">smooth</span></p></body></html>"))
        self.lineEdit_4.setText(_translate("Form", "2000"))
        self.checkBox_8.setText(_translate("Form", "aimlock (on m1)"))
        self.checkBox_9.setText(_translate("Form", "trigger bot"))
        self.label_12.setText(_translate("Form",
                                         "<html><head/><body><p><span style=\" font-weight:600; color:#2eec71;\">delay</span></p></body></html>"))
        self.lineEdit_5.setText(_translate("Form", "0.1"))
        self.label_13.setText(_translate("Form",
                                         "<html><head/><body><p><span style=\" font-weight:600; color:#2eec71;\">button</span></p></body></html>"))
        ...
        self.label_15.setText(_translate("Form",
                                         "<html><head/><body><p align=\"center\"><span style=\" font-weight:600; color:#2eec71;\">misc</span></p></body></html>"))
        ...
        self.checkBox_14.setText(_translate("Form", "no flash"))
        self.checkBox_15.setText(_translate("Form", "reveal money"))
            ...
            for x in range(32):
                if pm.read_int(client + dwEntityList + x * 0x10):
                    ...
                    if spotted == 1 << localplayer_index and localplayer_team != entity_team and entity_hp > 0:
                        ...
                        aimbone = GetBestBonetarget(localpos1, localpos2, localpos3, localpos_x_angles,
                                                    localpos_y_angles, entity)
    ...
    while aim_lock_status:
        if GetKeyState(1) == -127 or GetKeyState(1) == -128:
            ...
            for i in range(1, 64):
                ...
                if entity:
                    try:
                        entity_team_id, entity_hp, entity_dormant = pm.read_int(entity + m_iTeamNum), pm.read_int(
                            entity + m_iHealth), pm.read_int(entity + m_bDormant)
                    except:
                        time.sleep(1)
                        continue
                    ...
                    if localTeam != entity_team_id and entity_hp > 0:
                        entity_bones = pm.read_int(entity + m_dwBoneMatrix)
                        localpos_x_angles, localpos_y_angles = pm.read_float(
                            engine_pointer + dwClientState_ViewAngles), pm.read_float(
                            engine_pointer + dwClientState_ViewAngles + 0x4)
                        localpos1, localpos2 = pm.read_float(player + m_vecOrigin), pm.read_float(
                            player + m_vecOrigin + 4)
                    ...
                    if target and target_hp > 0 and not target_dormant:
                        ...
                        punchx, punchy = pm.read_float(player + m_aimPunchAngle), pm.read_float(
                            player + m_aimPunchAngle + 0x4)
...
try:
    if __name__ == "__main__":
        ...
        def start_variable():
            ...
            gun_id_list = {32: 0, 262205: 0, 4: 0, 2: 0, 36: 0, 30: 0, 262207: 0, 1: 0, 3: 0, 262208: 0, 35: 0, 25: 0,
                           27: 0, 14: 0, 28: 0, 29: 0, 17: 0, 262167: 0, 24: 0, 19: 0, 26: 0, 34: 0, 33: 0, 10: 0, 16: 0,
                           262204: 0, 40: 0, 8: 0, 9: 0, 38: 0, 13: 0, 7: 0, 39: 0, 11: 0}
        ...
        def AIM_():
            ...
            if ui.comboBox.currentText() == 'head':
                bone = 8
            if ui.comboBox.currentText() == 'neck':
                bone = 7
            if ui.comboBox.currentText() == 'chest':
                bone = 5
            if ui.comboBox.currentText() == 'stomach':
                bone = 3
        ...
        def chams_Set_Color():
            ...
            ui.pushButton_4.setStyleSheet(
                "QPushButton{background-color: rgb(" + f"{chamsR},{chamsG},{chamsB}" + "); border: none; border-radius: 2px;}")
        ...
        def esp_Set_Color():
            ...
            ui.pushButton_3.setStyleSheet(
                "QPushButton{background-color: rgb(" + f"{espR},{espG},{espB}" + "); border: none; border-radius: 2px;}")
        ...
        def read_game():
            ...
            try:
                ...
                ctypes.windll.user32.MessageBoxW(0, u"game process not found.", u"error", 0)
                out_side()
                return
            except:
                ctypes.windll.user32.MessageBoxW(0, "can't connect to the game.", u"error", 0)
                out_side()
                return
            ...
            def get_sig(modname, pattern, extra=0, offset=0, relative=True):
                ...
                bytes_ = pm.read_bytes(module.lpBaseOfDll, module.SizeOfImage)
        ...
        def save_cfg():
            ...
            config.set("misc", "no flash", str(no_flash_status))
            config.set("misc", "reveal money", str(ui.checkBox_15.isChecked()))
        ...
        def load_cfg():
            ...
            if bone == 8:
                ui.comboBox.setCurrentText("head")
            if bone == 7:
                ui.comboBox.setCurrentText("neck")
            if bone == 5:
                ui.comboBox.setCurrentText("chest")
            if bone == 3:
                ui.comboBox.setCurrentText("stomach")
            ...
            no_flash_status = config.get("misc", "no flash")
            show_money = config.get("misc", "reveal money")
    ...
    ctypes.windll.user32.MessageBoxW(0, u"pizda ruly: "+str(e), u"error", 0)
